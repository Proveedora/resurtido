...
<div class="form-group ${hasErrors(bean: almacenInstance, field: 'clave', 'error')} required">
	<div class="col-xs-2">
	<label for="clave">
...
<div class="form-group ${hasErrors(bean: almacenInstance, field: 'direccionDB', 'error')} required">
	<div class="col-xs-4">
...
<div class="form-group ${hasErrors(bean: almacenInstance, field: 'nombre', 'error')} required">
	<div class="col-xs-3">
	<label for="nombre">
